...
testing/
  ...
  scripts/
    playwright_test.py  ← 97 test groups, ~560 assertions
...
- **CI matrix runs on PHP 8.1–8.4** — `.github/workflows/php.yml` is a 4-version matrix (`8.1`, `8.2`, `8.3`, `8.4`) running PHPUnit, PHPStan L9 (`--memory-limit=512M`), PHPCS (PSR-12), and Spectral on every PR and push to `main`/`dev`.
