...
**Tracking PR:** [#316](https://github.com/seanmousseau/Subnet-Calculator/pull/316) (release/v3.0.0 → main, ready for review 2026-05-04)
...
| **B** | PR2 — Admin hardening | #311, #313, #307 (matrix) | ✅ Merged (PR #318) | Auth-touching; needs careful review |
| **C** | PR3a — Keyboard + history | #300, #301 | ✅ Merged (PR #319) | Split agreed: tree editor (#302) is its own PR3b |
| **C₂** | PR3b — Tree editor | #302 | ✅ Merged (PR #320) | Headline feature; depends on PR1 schema bump (already merged); follows design lock |
| **D** | PR4 — Release cut | — | 🟡 In review (PR #316, release/v3.0.0 → main) | Version bump, CHANGELOG, README, mkdocs, tarball |
...
| Per-key RPM upper bound | No explicit cap — operators may configure high RPM limits if desired; see `admin.md` for guidance | Session A |
...
**PR:** [#317](https://github.com/seanmousseau/Subnet-Calculator/pull/317) ✅ merged into `release/v3.0.0`
...
**PR:** [#318](https://github.com/seanmousseau/Subnet-Calculator/pull/318) ✅ merged into `release/v3.0.0`
...
**PR:** [#319](https://github.com/seanmousseau/Subnet-Calculator/pull/319) ✅ merged into `release/v3.0.0`
...
**PR:** [#320](https://github.com/seanmousseau/Subnet-Calculator/pull/320) ✅ merged into `release/v3.0.0`
...
### Session D — 2026-05-04 — PR4 Release cut
_(template — same shape as Session A; ends with merged release/v3.0.0 → main PR + release tag)_
